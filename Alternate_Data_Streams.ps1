              ...
              foreach($bad_file in $bad_files){
               ...
               if(Test-Path -Path "C:$file_paths\$bad_file"){
                   ...
                   if ($i -lt $(($nfp_files.Count + 1))){ 
                    ...
                    Write-Host " " # Space added for cleaner output
                    Write-host -ForegroundColor Green "Creating directory C:\Users\Bob\Sectioned_Off$i"
                    New-Item -ItemType Directory  -Path "C:\Users\Bob\Sectioned_Off$i"
                    ...
                    #>
                    Write-Host " " # Space added for cleaner output
                    Write-Host -ForegroundColor Green "NOW COPYING $bad_file TO C:\Users\Bob\Sectioned_Off$i"
                    Copy-Item "C:$file_path\$bad_file" -Destination "C:\Users\Bob\Sectioned_Off$i"
